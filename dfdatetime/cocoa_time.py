...
class CocoaTime(interface.DateTimeValues):
  ...
  def CopyFromDateTimeString(self, time_string):
    ...
    if microseconds is not None:
      timestamp += float(microseconds) / self._MICROSECONDS_PER_SECOND
  ...
  def CopyToDateTimeString(self):
    ...
    microseconds = int((self.timestamp % 1) * self._MICROSECONDS_PER_SECOND)
  ...
  def GetPlasoTimestamp(self):
    ...
    timestamp = self._MICROSECONDS_PER_SECOND * (
