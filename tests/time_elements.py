...
class TimeElementsInMillisecondsTest(unittest.TestCase):
  ...
  def testInitialize(self):
    ...
    self.assertEqual(
        time_elements_object._time_elements_tuple, expected_time_elements_tuple)
    self.assertEqual(time_elements_object.fraction_of_second, 0.546)
  ...
  def testCopyFromDateTimeString(self):
    ...
    self.assertEqual(
        time_elements_object._number_of_seconds, expected_number_of_seconds)
    self.assertEqual(time_elements_object.fraction_of_second, 0.0)
  ...
  def testCopyFromStringISO8601(self):
    ...
    self.assertEqual(
        time_elements_object._number_of_seconds, expected_number_of_seconds)
    self.assertEqual(time_elements_object.fraction_of_second, 0.5)
  ...
  def testCopyToStatTimeTuple(self):
    ...
    expected_stat_time_tuple = (1281643591, 4290000)
    stat_time_tuple = time_elements_object.CopyToStatTimeTuple()
    self.assertEqual(stat_time_tuple, expected_stat_time_tuple)
...
class TimeElementsInMicrosecondsTest(unittest.TestCase):
  ...
  def testInitialize(self):
    ...
    self.assertEqual(
        time_elements_object._time_elements_tuple, expected_time_elements_tuple)
    self.assertEqual(time_elements_object.fraction_of_second, 0.000546)
  ...
  def testCopyFromDateTimeString(self):
    ...
    self.assertEqual(
        time_elements_object._number_of_seconds, expected_number_of_seconds)
    self.assertEqual(time_elements_object.fraction_of_second, 0.546875)
  ...
  def testCopyFromStringISO8601(self):
    ...
    self.assertEqual(
        time_elements_object._number_of_seconds, expected_number_of_seconds)
    self.assertEqual(time_elements_object.fraction_of_second, 0.500000)
  ...
  def testCopyToStatTimeTuple(self):
    ...
    expected_stat_time_tuple = (1281643591, 4298760)
    stat_time_tuple = time_elements_object.CopyToStatTimeTuple()
    self.assertEqual(stat_time_tuple, expected_stat_time_tuple)
  ...
  def testGetPlasoTimestamp(self):
    ...
    expected_micro_posix_number_of_seconds = 1281643591429876
    micro_posix_number_of_seconds = time_elements_object.GetPlasoTimestamp()
    self.assertEqual(
        micro_posix_number_of_seconds, expected_micro_posix_number_of_seconds)
