...
class DotNetDateTimeTest(unittest.TestCase):
    ...
    def testProperties(self):
        ...
        dotnet_date_time = dotnet_datetime.DotNetDateTime(timestamp=637751130027210000)
    ...
    def testCopyToDateTimeString(self):
        ...
        dotnet_date_time = dotnet_datetime.DotNetDateTime(timestamp=637433280000000000)

        dotnet_date_string = dotnet_date_time.CopyToDateTimeString()
        self.assertEqual(dotnet_date_string, "2020-12-12 00:00:00.0000000")

        dotnet_date_time = dotnet_datetime.DotNetDateTime(timestamp=637433719320000000)
