...
class TimeElementsTest(unittest.TestCase):
    ...
    def testInitialize(self):
        ...
        with self.assertRaises(ValueError):
            time_elements.TimeElements(time_elements_tuple=(2010, 8, 12, 20, 6))

        with self.assertRaises(ValueError):
            time_elements.TimeElements(time_elements_tuple=(2010, 2, 29, 20, 6))

        with self.assertRaises(ValueError):
            time_elements.TimeElements(time_elements_tuple=(2010, 13, 12, 20, 6, 31))
    ...
    def testCopyDateTimeFromStringISO8601(self):
        ...
        date_dict = time_elements_object._CopyDateTimeFromStringISO8601("2010-08-12")
    ...
    def testCopyTimeFromStringISO8601(self):
        ...
        time_tuple = time_elements_object._CopyTimeFromStringISO8601("20:23:56+05:30")
        self.assertEqual(time_tuple, expected_time_tuple)
        ...
        time_tuple = time_elements_object._CopyTimeFromStringISO8601("20:23:56.327124")
        self.assertEqual(time_tuple, expected_time_tuple)
        ...
        expected_time_tuple = (8, 4, 32, None, 0)
        time_tuple = time_elements_object._CopyTimeFromStringISO8601("08:04:32+00:00")
        self.assertEqual(time_tuple, expected_time_tuple)
    ...
    def testCopyFromStringISO8601(self):
        ...
        expected_time_elements_tuple = (2010, 8, 12, 21, 6, 31)
        time_elements_object.CopyFromStringISO8601("2010-08-12T21:06:31.546875-01:00")
        self.assertEqual(
            time_elements_object._time_elements_tuple, expected_time_elements_tuple
        )
        self.assertEqual(time_elements_object._number_of_seconds, 1281647191)
        ...
        time_elements_object.CopyFromStringISO8601("2012-03-05T20:40:00.0000000+00:00")
        self.assertEqual(
            time_elements_object._time_elements_tuple, expected_time_elements_tuple
        )
